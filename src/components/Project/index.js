            ...
            <div className="row">
                <div className="column">
                    <div className="img-wrap">
                        ...
                        <div className="img-overlay img-overlay--blur">
                            <a href="https://grade-gatsby.herokuapp.com/" className="click" >
                    ...
                    <div className="img-wrap">
                        ...
                        <div className="img-overlay img-overlay--blur">
                            <a href="https://github.com/taystarr/thought-provoking" className="click" >
                    ...
                    <div className="img-wrap">
                        ...
                        <div className="img-overlay img-overlay--blur">
                            <a href="https://blindsweatyhansolo.github.io/ballzandbooze/" className="click" >
                ...
                <div className="column">
                    <div className="img-wrap">
                        ...
                        <div className="img-overlay img-overlay--blur">
                            <a href="https://github.com/taystarr/backend-e-commerce" className="click" >
                    ...
                    <div className="img-wrap">
                        ...
                        <div className="img-overlay img-overlay--blur">
                            <a href="https://taystarr.github.io/weather-dashboard/" className="click" >
                    ...
                    <div className="img-wrap">
                        ...
                        <div className="img-overlay img-overlay--blur">
                            <a href="https://taystarr.github.io/challenge-2/" className="click" >
