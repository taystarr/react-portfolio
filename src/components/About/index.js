...
function About() {
    return (
        <section>
            ...
            new restaurants, going to Nats games with friends, and hanging out with my cat, <a href='https://drive.google.com/file/d/1SSwHWtlHMqZfnaKmVd5cbvqOkBDf5AXQ/view?usp=sharing' className='home-btn'>Darren</a>. I recently moved to Washington, DC in the midst of the 
            ...
            appreciate the process of making aesthetic UIs. My hope is to use the skills I’ve learned in 
